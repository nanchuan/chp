...
 
  ...
  <tr>
	...
	<?php
        $oFCKeditor = new FCKeditor ( 'content' );           //实例化FCKeditor
        $oFCKeditor->BasePath = "../include/fckeditor/";     //指定基础路径
        $oFCKeditor->ToolbarSet = 'MyToolbar';               //指定工具条
        $oFCKeditor->Value = $article ['content'];           //指定初始值
        $oFCKeditor->Height = 350;                           //指定高度
        $oFCKeditor->Create ();                              //构建FCKeditor编辑器
    ?>    
	</td>
  </tr>
</table>
