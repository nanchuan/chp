...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" >
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="left_title">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="left_menu01">
        ...
        <tr>
          <td height="26"><img src="images/ico_03.gif" width="7" height="7" /> 
           <a href="article.php" target="mainFrame">文章管理</a></td>
        </tr>
        
        <tr>
          <td height="26"><img src="images/ico_03.gif" width="7" height="7" /> <a href="category.php" target="mainFrame">栏目管理</a></td>
        </tr>
        <tr>
          <td height="26"><img src="images/ico_03.gif" width="7" height="7" /> <a href="article.rubbish.php" target="mainFrame">垃圾箱管理</a></td>
        </tr>
      </table>
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="left_title">
        <tr>
	  ...
	  <tr>
          <td height="26"><img src="images/ico_03.gif" width="7" height="7" /> <a href="webconfig.php" target="mainFrame">网站设置</a><a href="admin/db_import.php" target="mainFrame"></a></td>
        </tr>
      </table>
      <br />
      <div style="font-size:12px; text-align:center; width:142px">
      </div>
      </td>
  </tr>
</table>
